...
Business-side coordination and delivery of a full ERP transformation across seven branches, including the design of company-wide order, inventory, and credit control business rules.
...
The prior system's absence of operational control created six confirmed failure conditions: no real-time inventory synchronization, no stock reservation logic, no negative-stock prevention, no credit limit enforcement, no approval governance with audit trail, and no reliable financial reporting.
